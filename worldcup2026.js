...
function rebuildDateFilter() {
  ...
  // Week grouping: week1=11-17/06, week2=18-24/06, week3=25/06+
  var WEEK_RANGES = [
    { dates: ["11/06","12/06","13/06","14/06","15/06","16/06","17/06"], labelVi: "Tuần 1 (11–17/06)", labelEn: "Week 1 (Jun 11–17)" },
    { dates: ["18/06","19/06","20/06","21/06","22/06","23/06","24/06"], labelVi: "Tuần 2 (18–24/06)", labelEn: "Week 2 (Jun 18–24)" },
    { dates: ["25/06","26/06","27/06","28/06"], labelVi: "Tuần 3 (25–28/06)", labelEn: "Week 3 (Jun 25–28)" },
  ];
  var addedHeader = {};
  order.forEach(function (o) {
    var label =
    ...
    for (var wi = 0; wi < WEEK_RANGES.length; wi++) {
      var wk = WEEK_RANGES[wi];
      if (wk.dates.indexOf(o.date) !== -1 && !addedHeader[wi]) {
        addedHeader[wi] = true;
        var hdr = document.createElement("div");
        hdr.className = "cs-week-header";
        hdr.textContent = currentLang === "vi" ? wk.labelVi : wk.labelEn;
        dd.appendChild(hdr);
        break;
      }
    }
...
var DATA = [
  ...
  },
  {
    ...
    group: "BẢNG B",
    round: "group",
    result: { homeScore: 4, awayScore: 1, goals: [{ team: "home", player: "J. Manzambi", min: "74'" }, { team: "home", player: "J. Manzambi", min: "90'" }, { team: "home", player: "R. Vargas", min: "84'" }, { team: "home", player: "G. Xhaka", min: "90+7' (P)" }, { team: "away", player: "E. Mahmić", min: "90+3'" }], reds: [{ team: "away", player: "T. Muharemović", min: "80'" }] },
  },
  {
    id: 27,
    day: "Thứ Sáu",
    ...
    group: "BẢNG B",
    round: "group",
    result: { homeScore: 6, awayScore: 0, goals: [{ team: "home", player: "C. Larin", min: "16'" }, { team: "home", player: "J. David", min: "29'" }, { team: "home", player: "J. David", min: "45+3'" }, { team: "home", player: "J. David", min: "90+2'" }, { team: "home", player: "N. Saliba", min: "64'" }, { team: "home", player: "M. Manai (OG)", min: "75'" }], reds: [{ team: "away", player: "H. Ahmed", min: "33'" }, { team: "away", player: "A. Madibo", min: "53'" }] },
  },
  {
    id: 28,
    day: "Thứ Sáu",
    ...
    group: "BẢNG A",
    round: "group",
    result: { homeScore: 1, awayScore: 0, goals: [{ team: "home", player: "L. Romo", min: "50'" }], reds: [] },
  },
  {
    id: 29,
    day: "Thứ Bảy",
